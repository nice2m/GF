...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of GameFoxOptLibs.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/GameFoxOptmizeLib/GameFoxOptLibs'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'GameFoxOptmizeLib' => 'gamefoxoptmizelib@gamefox.com' }
  s.source           = { :git => 'https://github.com/GameFoxOptmizeLib/GameFoxOptLibs.git', :tag => s.version.to_s }
